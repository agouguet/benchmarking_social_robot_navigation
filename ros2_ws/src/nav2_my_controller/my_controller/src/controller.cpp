...
#include "my_controller/controller.hpp"
...
void Controller::cleanup()
{
  RCLCPP_INFO(
    logger_,
    "Cleaning up controller: %s of type controller::Controller",
    plugin_name_.c_str());
  global_pub_.reset();
}
...
void Controller::activate()
{
  RCLCPP_INFO(
    logger_,
    "Activating controller: %s of type controller::Controller",
    plugin_name_.c_str());
...
void Controller::deactivate()
{
  RCLCPP_INFO(
    logger_,
    "Dectivating controller: %s of type controller::Controller",
    plugin_name_.c_str());
...
nav_msgs::msg::Path
Controller::transformGlobalPlan(
  const geometry_msgs::msg::PoseStamped & pose)
{
...
PLUGINLIB_EXPORT_CLASS(my_controller::Controller, nav2_core::Controller)