...
from agents_msgs.msg import AgentTrajectories # type: ignore
...
class EnvironmentInterpreterToGraph(Node):
...
def main(args=None):
    ...
    mbsn_node = EnvironmentInterpreterToGraph(save_policy=True)
