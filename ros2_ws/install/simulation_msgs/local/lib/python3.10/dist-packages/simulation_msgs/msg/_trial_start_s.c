...
bool simulation_msgs__msg__trial_start__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simulation_msgs.msg._trial_start.TrialStart", full_classname_dest, 43) == 0);
  }
  simulation_msgs__msg__TrialStart * ros_message = _ros_message;
  {  // header
  ...
  {  // spawn
    PyObject * field = PyObject_GetAttrString(_pymsg, "spawn");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__pose__convert_from_py(field, &ros_message->spawn)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // people
    ...
    if (!geometry_msgs__msg__pose_array__convert_from_py(field, &ros_message->people)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // time_limit
    ...
    ros_message->time_limit = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of TrialStart */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("simulation_msgs.msg._trial_start");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrialStart");
  ...
  {  // spawn
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose__convert_to_py(&ros_message->spawn);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "spawn", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // people
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose_array__convert_to_py(&ros_message->people);
    if (!field) {
      return NULL;
    }
    {
