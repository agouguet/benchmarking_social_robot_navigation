...
: ${AMENT_CURRENT_PREFIX:="/home/adam/Desktop/SBSN/ros2_ws/install/my_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_controller/environment/library_path.sh"
