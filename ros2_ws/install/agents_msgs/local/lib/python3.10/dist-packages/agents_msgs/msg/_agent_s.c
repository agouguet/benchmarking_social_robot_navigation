...
bool agents_msgs__msg__agent__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agents_msgs.msg._agent.Agent", full_classname_dest, 28) == 0);
  }
  agents_msgs__msg__Agent * ros_message = _ros_message;
  {  // header
  ...
  {  // visible_by_robot
    PyObject * field = PyObject_GetAttrString(_pymsg, "visible_by_robot");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->visible_by_robot = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * agents_msgs__msg__agent__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("agents_msgs.msg._agent");
  ...
  {  // visible_by_robot
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->visible_by_robot ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "visible_by_robot", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
