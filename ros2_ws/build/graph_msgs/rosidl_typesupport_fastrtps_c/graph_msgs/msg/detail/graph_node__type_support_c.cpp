...
#include "graph_msgs/msg/detail/graph_node__rosidl_typesupport_fastrtps_c.h"
...
using _GraphNode__ros_msg_type = graph_msgs__msg__GraphNode;
...
static uint32_t _GraphNode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_graph_msgs__msg__GraphNode(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graph_msgs__msg__GraphNode;
    is_plain =
      (
...
static size_t _GraphNode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graph_msgs__msg__GraphNode(
