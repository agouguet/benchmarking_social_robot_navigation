...
class GraphEdge(metaclass=Metaclass_GraphEdge):
    ...
    def __init__(self, **kwargs):
        ...
        self.id_n1 = kwargs.get('id_n1', int())
        self.id_n2 = kwargs.get('id_n2', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.id_n1 != other.id_n1:
            return False
        if self.id_n2 != other.id_n2:
            return False
        return True
    ...
    @id_n1.setter
    def id_n1(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'id_n1' field must be of type 'int'"
            assert value >= 0 and value < 18446744073709551616, \
                "The 'id_n1' field must be an unsigned integer in [0, 18446744073709551615]"
        self._id_n1 = value
    ...
    @id_n2.setter
    def id_n2(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'id_n2' field must be of type 'int'"
            assert value >= 0 and value < 18446744073709551616, \
                "The 'id_n2' field must be an unsigned integer in [0, 18446744073709551615]"
        self._id_n2 = value
