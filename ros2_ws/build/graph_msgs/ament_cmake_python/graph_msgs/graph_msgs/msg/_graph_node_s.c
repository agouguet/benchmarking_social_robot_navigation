...
bool graph_msgs__msg__graph_node__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("graph_msgs.msg._graph_node.GraphNode", full_classname_dest, 36) == 0);
  }
  graph_msgs__msg__GraphNode * ros_message = _ros_message;
  {  // id
...
PyObject * graph_msgs__msg__graph_node__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("graph_msgs.msg._graph_node");
