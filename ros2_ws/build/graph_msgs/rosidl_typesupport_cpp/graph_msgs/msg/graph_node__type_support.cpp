...
static const _GraphNode_type_support_symbol_names_t _GraphNode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graph_msgs, msg, GraphNode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, graph_msgs, msg, GraphNode)),
  }
};
...
get_message_type_support_handle<graph_msgs::msg::GraphNode>()
{
  return &::graph_msgs::msg::rosidl_typesupport_cpp::GraphNode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, graph_msgs, msg, GraphNode)() {
  return get_message_type_support_handle<graph_msgs::msg::GraphNode>();
}
