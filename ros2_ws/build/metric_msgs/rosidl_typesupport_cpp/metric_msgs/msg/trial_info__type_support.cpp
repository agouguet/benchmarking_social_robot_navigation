...
static const _TrialInfo_type_support_symbol_names_t _TrialInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, metric_msgs, msg, TrialInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, metric_msgs, msg, TrialInfo)),
  }
};
...
{
  return &::metric_msgs::msg::rosidl_typesupport_cpp::TrialInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, metric_msgs, msg, TrialInfo)() {
  return get_message_type_support_handle<metric_msgs::msg::TrialInfo>();
}
