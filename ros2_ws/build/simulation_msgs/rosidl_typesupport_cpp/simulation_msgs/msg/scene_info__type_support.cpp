...
static const _SceneInfo_type_support_symbol_names_t _SceneInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simulation_msgs, msg, SceneInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, simulation_msgs, msg, SceneInfo)),
  }
};
...
{
  return &::simulation_msgs::msg::rosidl_typesupport_cpp::SceneInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, simulation_msgs, msg, SceneInfo)() {
  return get_message_type_support_handle<simulation_msgs::msg::SceneInfo>();
}
