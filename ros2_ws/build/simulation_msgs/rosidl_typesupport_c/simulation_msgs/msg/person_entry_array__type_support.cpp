...
static const _PersonEntryArray_type_support_symbol_names_t _PersonEntryArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simulation_msgs, msg, PersonEntryArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simulation_msgs, msg, PersonEntryArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, simulation_msgs, msg, PersonEntryArray)() {
  return &::simulation_msgs::msg::rosidl_typesupport_c::PersonEntryArray_message_type_support_handle;
}
