...
#include "simulation_msgs/msg/detail/trial_start__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // spawn, target
#include "geometry_msgs/msg/detail/pose_array__functions.h"  // people
...
using _TrialStart__ros_msg_type = simulation_msgs__msg__TrialStart;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrialStart__ros_msg_type * ros_message = static_cast<const _TrialStart__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrialStart__ros_msg_type * ros_message = static_cast<_TrialStart__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_simulation_msgs__msg__TrialStart(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrialStart__ros_msg_type * ros_message = static_cast<const _TrialStart__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TrialStart__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_simulation_msgs__msg__TrialStart(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_simulation_msgs
size_t max_serialized_size_simulation_msgs__msg__TrialStart(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = simulation_msgs__msg__TrialStart;
    is_plain =
      (
...
static size_t _TrialStart__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_simulation_msgs__msg__TrialStart(
...
static message_type_support_callbacks_t __callbacks_TrialStart = {
  "simulation_msgs::msg",
  "TrialStart",
...
static rosidl_message_type_support_t _TrialStart__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrialStart,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simulation_msgs, msg, TrialStart)() {
  return &_TrialStart__type_support;
}
