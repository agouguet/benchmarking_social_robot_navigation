...
bool simulation_msgs__msg__person_entry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simulation_msgs.msg._person_entry.PersonEntry", full_classname_dest, 45) == 0);
  }
  simulation_msgs__msg__PersonEntry * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PersonEntry */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("simulation_msgs.msg._person_entry");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PersonEntry");
