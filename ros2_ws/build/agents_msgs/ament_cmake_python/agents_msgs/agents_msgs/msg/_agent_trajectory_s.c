...
bool agents_msgs__msg__agent_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agents_msgs.msg._agent_trajectory.AgentTrajectory", full_classname_dest, 49) == 0);
  }
  agents_msgs__msg__AgentTrajectory * ros_message = _ros_message;
  {  // header
  ...
  {  // poses
    ...
    geometry_msgs__msg__Point * dest = ros_message->poses.data;
...
{
  /* NOTE(esteve): Call constructor of AgentTrajectory */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("agents_msgs.msg._agent_trajectory");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AgentTrajectory");
