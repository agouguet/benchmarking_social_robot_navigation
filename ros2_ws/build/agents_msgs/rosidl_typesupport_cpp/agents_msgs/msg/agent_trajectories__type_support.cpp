...
static const _AgentTrajectories_type_support_symbol_names_t _AgentTrajectories_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agents_msgs, msg, AgentTrajectories)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, agents_msgs, msg, AgentTrajectories)),
  }
};
...
{
  return &::agents_msgs::msg::rosidl_typesupport_cpp::AgentTrajectories_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, agents_msgs, msg, AgentTrajectories)() {
  return get_message_type_support_handle<agents_msgs::msg::AgentTrajectories>();
}
