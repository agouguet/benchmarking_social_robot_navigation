...
class Agent(metaclass=Metaclass_Agent):
    ...
    def __init__(self, **kwargs):
        ...
        self.visible_by_robot = kwargs.get('visible_by_robot', bool())
    ...
    def __eq__(self, other):
        ...
        if self.velocity != other.velocity:
            return False
        if self.visible_by_robot != other.visible_by_robot:
            return False
        return True
    ...
    @builtins.property
    def visible_by_robot(self):
        """Message field 'visible_by_robot'."""
        return self._visible_by_robot

    @visible_by_robot.setter
    def visible_by_robot(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'visible_by_robot' field must be of type 'bool'"
        self._visible_by_robot = value
