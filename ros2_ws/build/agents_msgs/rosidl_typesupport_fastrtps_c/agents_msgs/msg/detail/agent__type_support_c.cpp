...
#include "agents_msgs/msg/detail/agent__rosidl_typesupport_fastrtps_c.h"
...
using _Agent__ros_msg_type = agents_msgs__msg__Agent;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: visible_by_robot
  {
    cdr << (ros_message->visible_by_robot ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: visible_by_robot
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->visible_by_robot = tmp ? true : false;
  }
...
size_t get_serialized_size_agents_msgs__msg__Agent(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Agent__ros_msg_type * ros_message = static_cast<const _Agent__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name visible_by_robot
  {
    size_t item_size = sizeof(ros_message->visible_by_robot);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Agent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_agents_msgs__msg__Agent(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agents_msgs
size_t max_serialized_size_agents_msgs__msg__Agent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agents_msgs__msg__Agent;
    is_plain =
      (
      offsetof(DataType, visible_by_robot) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Agent__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agents_msgs__msg__Agent(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agents_msgs, msg, Agent)() {
