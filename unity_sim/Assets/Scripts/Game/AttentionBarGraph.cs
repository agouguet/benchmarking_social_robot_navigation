...
public class AttentionBarGraph : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ROSConnection.GetOrCreateInstance().Subscribe<RosMessageTypes.Std.MFloat32MultiArray>(topic1, ReceiveMessageL);
        ROSConnection.GetOrCreateInstance().Subscribe<RosMessageTypes.Std.MFloat32MultiArray>(topic2, ReceiveMessageCmdVel);
    }
