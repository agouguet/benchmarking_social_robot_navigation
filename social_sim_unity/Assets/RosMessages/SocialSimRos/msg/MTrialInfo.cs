...
namespace RosMessageTypes.SocialSimRos
{
    public class MTrialInfo : Message
    {
        ...
        public double path_length; // # Approximate distance traveled by robot
        // float64                  mean_dist_to_target_not_moving                 # How far away from the target was the robot while not moving
        public double time_not_moving;// # Seconds the robot was not moving. Computed by checking if the robot moved more than 0.05m since a check the last 1s ago. If not, accumulate the time since the last check.
        ...
        public override List<byte[]> SerializationStatements()
        {
            ...
            listOfSerializations.Add(BitConverter.GetBytes(this.path_length));
            listOfSerializations.Add(BitConverter.GetBytes(this.path_irregularity));
            listOfSerializations.Add(BitConverter.GetBytes(this.time_not_moving));
            listOfSerializations.Add(BitConverter.GetBytes(this.time_in_personal_space));
        ...
        public override int Deserialize(byte[] data, int offset)
        {
            ...
            this.path_length = BitConverter.ToDouble(data, offset);
            offset += 8;
            this.path_irregularity = BitConverter.ToDouble(data, offset);
            offset += 8;
            this.time_not_moving = BitConverter.ToDouble(data, offset);
            offset += 8;
            this.time_in_personal_space = BitConverter.ToDouble(data, offset);
            offset += 8;
